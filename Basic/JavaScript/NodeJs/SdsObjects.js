...
module.exports = {
    ...
    SdsStream: function (sdsStream) {
        ...
        if (sdsStream.PropertyOverrides) {
            this.PropertyOverrides = sdsStream.PropertyOverrides;
        }
    },

    //Sds Stream Property Override Object
    SdsStreamPropertyOverride: function (sdsStreamPropertyOverride) {
        this.SdsTypePropertyId = sdsStreamPropertyOverride.SdsTypePropertyId;
        this.InterpolationModeOverride = sdsStreamPropertyOverride.InterpolationModeOverride;
        this.UomOverride = sdsStreamPropertyOverride.UomOverride;
    },
