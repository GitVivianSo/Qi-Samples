...
.. code:: javascript
    ...
    const behavior = new SdsStreamBehavior();
    behavior.Id = behaviorId;
    behavior.Name = 'SampleBehavior';
    behavior.Mode = SdsStreamMode.Discrete;
...
.. code:: javascript
    ...
    this.qiService.getRangeValues(streamId, '3', 5, SdsBoundaryType.ExactOrCalculated, autoViewId)
